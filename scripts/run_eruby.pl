...
my $html_dir = $ENV{HOME} . '/Generated/html_books/purcell';
...
#---------
my $index = $ENV{HOME} . '/Generated/html_books/purcell/index.html';
...
foreach (<ch*/*.rbtex>) {
  ...
  my $cmd = "m4 -P -D __web='$web_flag' purcell.m4 $file >$postm4";
