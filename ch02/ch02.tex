...
the vector $\grad\pot$ is defined so that it points in the direction of increas-
ing $\pot$.
...
not $r^2$, and the integral is a scalar not a vector. From the scalar po-
tential function $\pot(x,y,z)$ we can always find the electric field by taking
...
is dq = a - 2r0 dr. Its contribution to the potential at $P_2$ is
