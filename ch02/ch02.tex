...
with it. Once the vector field $\vc{E}$ is given, the potential function (p
...
a given field $\vc{E}$ with the potential energy of a system of charges. The
...
Thus if we identify $\vc{E}$ with -V(p, Eqs. 13 and 14 become identical. So
...
tion F. That is, $\curl\vc{F}$ is itself a Vector function of the coordinates.
...
ber that the line integral of $\vc{E}$ between any two points such as P1 and
